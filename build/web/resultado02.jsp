...
<html>
    ...
    <body>
        ...
        <div class="row py-5">
            <div class="container">
                <div align="center" class="tittle">Resultado de la operación</div>
                <br>
                <%
                    int number = Integer.parseInt(request.getParameter("number"));
                    if (number >= 0){
                        if (number == 0){
                            out.println("El número " + number + " es par");
                        } else if (number %2 == 0){
                            out.println("El número " + number + " es entero positivo par");
                        } else {
                            out.println("El número " + number + " es entero positivo impar");
                            }
                    } else {
                        if (number %2 == 0){
                            out.println("El número " + number + " es entero negativo par");
                        } else  {
                            out.println("El número " + number + " es entero negativo impar");
                                }
                            }
                %>            
            </div>
        ...
        <footer class="text-end">
            <div>
                ...
                <br>
                <a href="ejercicio02.html" style="color:graytext; text-decoration:none"><b>Volver a página anterior</b><a/>
            </div>
        </footer>            

...
<html>
    ...
    <body>
        ...
        <div class="row py-5">
            <div class="container">
                <div align="center" class="tittle">Resultado</div>
                <br>
                <%
            ...
            String cadena = "";
             if (n >= 1 && n <= 30) {
                ...
                %> 
                <script>
                    alert("INGRESE UN VALOR ENTERO POSITIVO Y MENOR A 30");
                </script>
                <% 
               }
                %>
        ...
        <footer class="text-end">
            <div>
                ...
                <br>
                <a href="ejercicio05.html" style="color:graytext; text-decoration:none"><b>Volver a página anterior</b><a/>
            </div>
        </footer>
